...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        if(request.getServletPath().equals("/api/v1/security/login") || request.getServletPath().equals("/api/v1/security/refresh")  || request.getServletPath().equals("/api/v1/security/save") || request.getServletPath().equals("/api/v1/security/test")){
